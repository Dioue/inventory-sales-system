...
document.addEventListener('DOMContentLoaded', () => {
    const activityLogBtn = document.querySelector('.activity-btn');
    const activityModal = document.querySelector('#activity-log');
    const acitivityLogHide = document.querySelector('#activity-log-hide');
    ...
    if (document.getElementById("activity-log-table") && typeof simpleDatatables.DataTable !== 'undefined') {
        ...
        activityLogTable = new simpleDatatables.DataTable("#activity-log-table", {
            searchable: false,
            perPage: 5,
            perPageSelect: [5, 10],
